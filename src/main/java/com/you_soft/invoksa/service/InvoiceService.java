...
public class InvoiceService {
    ...
    public InvoiceResponse create(InvoiceRequest invoiceRequest) {
        ...
        Client client = clientRepository.findById(invoiceRequest.getClientId())
                .orElseThrow(
                        () -> new RuntimeException("Client introuvable avec l'id: " + invoiceRequest.getClientId()));
    ...
    public InvoiceResponse update(Long id, InvoiceRequest invoiceRequest) {
        ...
        invoice.setSum(invoiceRequest.getTotal());
        invoice.setStatus(invoiceRequest.getStatusCode());
    ...
    public byte[] getInvoicePdf(Long id) {
        ...
        invoiceMap.put("total", invoice.getSum() != null ? invoice.getSum() : 0.0);
    ...
    public byte[] invoicePdfAi(String description, String lang, String devise) {
        try {
            ...
            // Préparer la Map pour PDF
            Map<String, Object> invoiceMap = new HashMap<>();
            invoiceMap.put("id", invoice.getId());
            invoiceMap.put("clientName", invoice.getClient() != null ? invoice.getClient().getName() : "Inconnu");
            invoiceMap.put("date",
            ...
            e.printStackTrace();
            return "Erreur génération PDF".getBytes(StandardCharsets.UTF_8);
        }
    }
}